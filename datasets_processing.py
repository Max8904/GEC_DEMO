...
if __name__ == "__main__":
    ...
    # of -> original
    # rf -> reference
    train_of = open("l8_train_original.txt", 'w', encoding='utf-8')
    train_rf = open("l8_train_reference.txt", 'w', encoding='utf-8')
    test_of = open("l8_test_original.txt", 'w', encoding='utf-8') 
    test_rf = open("l8_test_reference.txt", 'w', encoding='utf-8') 

    train_indices = read_indices()
